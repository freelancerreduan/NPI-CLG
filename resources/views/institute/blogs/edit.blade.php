    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('institute.index') }}">Dashboard</a></li>
        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card card-info">
                    ...
                    <form class="form-horizontal" action="{{ route('institute.blog.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                      <div class="card-body">
