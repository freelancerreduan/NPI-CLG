                ...
                <tbody>
                    @foreach ($blogs as $blog)
                        <tr>
                            ...
                            <td>{{ $blog->status }}</td>
                            <td class="text-nowrap">
                                <a href="{{ route('institute.blog.edit', $blog->id) }}" class="btn btn-sm btn-primary d-inline">Edit</a>
                                <form action="{{ route('institute.blog.destroy', $blog->id) }}" class="d-inline" method="POST">
                                    @csrf
                                    @method('DELETE')
