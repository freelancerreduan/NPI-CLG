                ...
                <div class="card card-info">
                    ...
                    <form class="form-horizontal" action="{{ route('blog.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="section" id="section" class="form-control">
                                    ...
                                    <option {{ $blog->section == 'top' ?  'selected' : '' }} value="top">Top</option>
                                    <option {{ $blog->section == 'trending' ?  'selected' : '' }} value="trending">Trending</option>
                                    <option {{ $blog->section == 'latest' ?  'selected' : '' }} value="latest">Latest</option>
                                </select>
                                @error('section')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="status" id="status" class="form-control">
                                    ...
                                    <option {{ $blog->status == 'approved' ? 'selected' : '' }} value="approved">Publish</option>
                                    <option {{ $blog->status == 'rejected' ? 'selected' : '' }} value="rejected">Rejected</option>
                                </select>
                                @error('status')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                      ...
                      <div class="card-footer">
                        <button type="submit" class="btn btn-info btn-block">Update Blog</button>
                      </div>
                      <!-- /.card-footer -->
                    </form>
                </div>
