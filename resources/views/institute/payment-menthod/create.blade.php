                    ...
                    <form class="form-horizontal" action="{{ route('payment-method.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="account_number" placeholder="Enter Account Number" name="account_number" value="{{ old('account_number') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="short_description" class="form-control" id="short_description" placeholder="Enter Description" rows="5">{{ old('short_description') }}</textarea>
                            ...
                            <div class="">
                                <button type="submit" class="btn btn-info btn-block">Create Payment Method</button>
                            </div>
                      </div>
                        <!-- /.card-body -->
                        <!-- /.card-footer -->
